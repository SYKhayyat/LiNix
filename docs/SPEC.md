...
| [`spec/decisions.md`](spec/decisions.md) | — | **All 124 decisions. 120 answered, 2 parked, two open (Q14, Q15).** Counted, not typed — `scripts/decision-count.sh --check`. | Before proposing anything. |
