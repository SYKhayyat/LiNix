...
| [`spec/decisions.md`](spec/decisions.md) | — | **All 126 decisions. 124 answered, 2 parked, none open.** Counted, not typed — `scripts/decision-count.sh --check`. | Before proposing anything. |
