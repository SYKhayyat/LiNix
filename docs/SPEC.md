...
| [`spec/decisions.md`](spec/decisions.md) | — | **All 223 decisions. 214 ANSWERED, 2 PARKED, 1 DEFERRED, 2 HALF RULED, 0 BUILT NEVER RULED, 4 OPEN.** Counted, not typed — `scripts/decision-count.sh --check`. | Before proposing anything. |
