...
| [`spec/decisions.md`](spec/decisions.md) | — | **All 129 decisions. 127 ANSWERED, 1 PARKED, 1 OPEN (`D15`, not blocking).** Counted, not typed — `scripts/decision-count.sh --check`. | Before proposing anything. |
