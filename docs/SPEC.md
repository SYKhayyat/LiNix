...
| [`spec/decisions.md`](spec/decisions.md) | — | **All 113 decisions. 111 answered, 2 parked, zero open.** Counted, not typed — `scripts/decision-count.sh --check`. | Before proposing anything. |
