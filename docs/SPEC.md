...
| [`spec/decisions.md`](spec/decisions.md) | — | **All 116 decisions. 114 answered, 2 parked, zero open.** Counted, not typed — `scripts/decision-count.sh --check`. | Before proposing anything. |
