...
| [`spec/decisions.md`](spec/decisions.md) | — | **All 123 decisions. 120 answered, 2 parked, one open (Q14).** Counted, not typed — `scripts/decision-count.sh --check`. | Before proposing anything. |
