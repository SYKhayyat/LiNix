...
| [`spec/decisions.md`](spec/decisions.md) | — | **All 137 decisions. 134 ANSWERED, 2 PARKED, 1 BUILT NEVER RULED, 0 OPEN.** Counted, not typed — `scripts/decision-count.sh --check`. | Before proposing anything. |
