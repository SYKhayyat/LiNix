...
| [`spec/decisions.md`](spec/decisions.md) | — | **All 130 decisions. 128 ANSWERED, 2 PARKED, 0 OPEN.** Counted, not typed — `scripts/decision-count.sh --check`. | Before proposing anything. |
