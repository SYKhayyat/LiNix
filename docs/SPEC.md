...
| [`spec/decisions.md`](spec/decisions.md) | — | **All 166 decisions. 160 ANSWERED, 2 PARKED, 1 DEFERRED, 1 HALF RULED, 1 BUILT NEVER RULED, 1 OPEN.** Counted, not typed — `scripts/decision-count.sh --check`. | Before proposing anything. |
