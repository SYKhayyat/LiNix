...
| [`spec/decisions.md`](spec/decisions.md) | — | **All 121 decisions. 117 answered, 2 parked, 2 open (Q10 mix/Hex, Q11 opam switch).** Counted, not typed — `scripts/decision-count.sh --check`. | Before proposing anything. |
