...
| [`spec/decisions.md`](spec/decisions.md) | — | **All 127 decisions. 124 answered, 2 parked, 1 open (`Q18`).** Counted, not typed — `scripts/decision-count.sh --check`. | Before proposing anything. |
