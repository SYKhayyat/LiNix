...
| [`spec/decisions.md`](spec/decisions.md) | — | **All 150 decisions. 143 ANSWERED, 2 PARKED, 1 BUILT NEVER RULED, 2 OPEN.** Counted, not typed — `scripts/decision-count.sh --check`. | Before proposing anything. |
