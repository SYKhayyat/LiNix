...
| [`spec/decisions.md`](spec/decisions.md) | — | **All 122 decisions. 120 answered, 2 parked, none open.** Counted, not typed — `scripts/decision-count.sh --check`. | Before proposing anything. |
