...
| [`spec/decisions.md`](spec/decisions.md) | — | **All 178 decisions. 170 ANSWERED, 2 PARKED, 1 DEFERRED, 1 HALF RULED, 2 BUILT NEVER RULED, 2 OPEN.** Counted, not typed — `scripts/decision-count.sh --check`. | Before proposing anything. |
