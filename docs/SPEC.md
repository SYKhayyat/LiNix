...
| [`spec/decisions.md`](spec/decisions.md) | — | **All 125 decisions. 120 answered, 2 parked, three open (Q14, Q15, Q16).** Counted, not typed — `scripts/decision-count.sh --check`. | Before proposing anything. |
