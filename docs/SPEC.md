...
| [`spec/decisions.md`](spec/decisions.md) | — | **All 213 decisions. 206 ANSWERED, 2 PARKED, 1 DEFERRED, 1 HALF RULED, 1 BUILT NEVER RULED, 2 OPEN.** Counted, not typed — `scripts/decision-count.sh --check`. | Before proposing anything. |
